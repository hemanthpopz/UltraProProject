          ...
          <div className="probinar-content-container">
            ...
            <div className="probinar-second-container">
              ...
              <p className="probinar-second-des">
                ...
                blockchain technology. Pioneering education is our pride,
                offering cutting-edge learning in blockchain, cryptocurrencies,
            ...
            <div className="probinar-fourth-container">
              <ul className="probinar-ul">
                ...
                <li>
                  ...
                  <p>
                    Probinar" Online Webinar Classes by Ultrapro Academy offer
                    an unparalleled chance to enrich your knowledge, share
                    valuable insights, and earn simultaneously.
                  </p>
                  <div className="explore-container">
                    <p className="explore">EXPLORE MORE</p>
                    <img src={Arrow} />
              ...
              <div className="single-probinar-ul-item">
                <div className="single-probinar-text-container">
                  ...
                  <p className="single-probinar-text-container-p">
                    ...
                    from even-numbered direct introductions. Unlimited
                    Referrals: Introduce an unlimited number of allies and
                    benefit from a 100% distribution across 10 levels
                  </p>
                  <div className="explore-container">
                    <p className="explore">EXPLORE MORE</p>
                    <img src={Arrow} />
